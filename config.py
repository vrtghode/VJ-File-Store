...
DB_URI = environ.get("DB_URI", "mongodb+srv://vrtuniverse:<password>@cluster0.qbfmgoc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002202024730"))
